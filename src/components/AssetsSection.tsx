    ...
    return (
        <section>
            ...
            <thead>
                ...
                return (
                <th key={field} className="px-1 py-1 text-left font-normal text-xs text-gray-500">
            ...
            <tbody>
                ...
                const textColor = field === 'volatility'
                    ? 'text-black'
                    ...
                    : 'text-black';
                return (
                    <td key={`${item.id || rowIndex}-${field}`} className={`px-1 py-1 text-left ${textColor}`}>
                    {displayValue}
                    </td>
                );
                })}
